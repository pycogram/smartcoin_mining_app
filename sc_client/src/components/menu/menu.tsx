    ...
    return ( 
        <div>
            <div className="menu-section">
                <header>
                    <span onClick={handleMenuBox} className="menu-bar">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="menu-bar-icon">
                ...
                <main className="menu-option">
                    {
                        ...
                        <div onClick={() => (handlePage("dashboard"))} className={activePage === "dashboard" ? "dmo-i-p dmo-i-p-active" : "dmo-i-p"}>
                    ...
                    {
                        window.innerWidth > 768 && 
                        <div onClick={() => (handlePage("all-post"))} className={activePage === "all-post" ? "dmo-i-p dmo-i-p-active" : "dmo-i-p"}>
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
                    ...
                    {
                        window.innerWidth > 768 && 
                        <div onClick={() => (handlePage("setting"))} className={activePage === "setting" ? "dmo-i-p dmo-i-p-active" : "dmo-i-p"}>
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
                ...
                <footer  className="social-link">
                    ...
                    <a href="#" target="_blank" className="fa-brands fa-x-twitter"></a>
                    <a href="#" target="_blank" className="fa-brands fa-telegram"></a>
                    <a href="#" target="_blank" className="fa-brands fa-discord"></a>
                </footer>
            </div>
            <span onClick={handleMenuBox} className="over-lay"></span>
        </div>
     );
}
